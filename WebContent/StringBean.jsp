...
<jsp:useBean id="stringBean" class="com.beat_software.javaweb.StringBean"/>
<OL>
...
<%-- Just to illustrate that the created bean is set as an attribute in the page scope--%>
<%= pageContext.getAttribute("stringBean") %>        
</BODY></HTML>